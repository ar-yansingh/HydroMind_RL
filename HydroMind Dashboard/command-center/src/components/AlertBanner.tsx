...
export default function AlertBanner() {
  ...
  return (
    <div className="w-full z-50 flex justify-center px-4 py-2" style={{ background: 'rgba(127,29,29,0.15)' }}>
      <div className="px-5 py-2.5 rounded-xl bg-red-950/80 border border-red-500/40 backdrop-blur-lg flex items-center gap-3 shadow-[0_4px_24px_rgba(239,68,68,0.15)]">
